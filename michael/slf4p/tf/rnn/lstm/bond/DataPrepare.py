...
dataset = pd.read_csv('/Users/ch/eclipse-workspace/neural-rnn/src/main/resources/data/train-seq.data', parse_dates=[['year', 'month', 'day', 'hour']], index_col=0, date_parser=parse)
...
dataset.to_csv('/Users/ch/git/tf/bid-seq.csv')